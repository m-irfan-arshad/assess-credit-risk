package com.ai.credit.risk.di

import android.content.Context
import com.ai.credit.risk.BuildConfig

import com.ai.credit.risk.data.FallbackRiskClassifier
import com.ai.credit.risk.data.LiteRtRiskClassifier
import com.ai.credit.risk.domain.classifier.RiskClassifier
 ...
 *
 * Provides the [com.ai.credit.risk.domain.classifier.RiskClassifier] implementation based on the ML_ENABLED
 * feature flag in BuildConfig. When ML is disabled (kill switch active),
 * a [com.ai.credit.risk.data.FallbackRiskClassifier] is used instead — it returns REVIEW for
